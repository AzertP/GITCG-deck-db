const allCharacterTags = {
    ['element']: ['Hydro', 'Pyro', 'Electro', 'Geo', 'Dendro', 'Anemo', 'Cryo'],
    ['weapon']: ['Sword', 'Bow', 'Claymore', 'Catalyst', 'Polearm', 'Other Weapons'],
    ['region']: ['Mondstadt', 'Sumeru', 'Inazuma', 'Liyue', 'Fontaine', 'Natlan'],
    ['faction']: ['Monster', 'Fatui', 'The Eremites', 'Hilichurl', 'Consecrated Beast'],
